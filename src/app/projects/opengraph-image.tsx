...
export const alt = "Projects by Mikheil Berishvili";
...
export default async function ProjectsOgImage() {
  ...
  const names = pagedProjects.slice(0, 8).map((p) => p.title);
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          >
            Developer tools, macOS apps and .NET libraries
          </div>
          <div
            style={{
              display: "flex",
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          >
            ...
            <div style={{ display: "flex" }}>
              {meta.siteUrl.replace("https://", "")}/projects
            </div>
          </div>
        </div>
      </div>
